...
class PauseRegressionDataModule(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if not self.tokenizer:
            ...
            elif "ai-forever/mGPT" in self.hparams.model_name:
                print('Using mGPT tokenizer')
                self.tokenizer = AutoTokenizer.from_pretrained(self.hparams.model_name)
                self.tokenizer.pad_token_id = self.tokenizer.eos_token_id
            else:
        ...
        all_duration = self.train_durations + self.val_durations
        (
            self.train_texts,
            self.val_texts,
            self.train_durations,
